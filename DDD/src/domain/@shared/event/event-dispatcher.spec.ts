...
import { CallConsoleLogWhenCustomerAddressIsChanged } from "../../customer/event/handler/call-console-log-when-customer-address-is-changed.handler";
import { CallConsoleLogWhenCustomerIsCreated1Handler } from "../../customer/event/handler/call-console-log-when-customer-is-created-1.handler";
import { CallConsoleLogWhenCustomerIsCreated2Handler } from "../../customer/event/handler/call-console-log-when-customer-is-created-2.handler";
import { Address } from "../../customer/value-object/address";
import { SendEmailWhenProductIsCreatedHandler } from "../../product/event/handler/send-email-when-producted-is-created.handler";
